...
//                alert("funciona");
                            ...
                            window.location.href = "artigo_pag14.php";
    ...
    <body>
        <div class="container">
            ...
            <h5 style="margin-top: 75px;">COLABORADORES</h5>
            <div class="border-top-bottom">
                <p>S. S. Castro participou na revisão da literatura, análise dos resultados e redação do artigo final. C. L. G. César colaborou na elaboração do projeto, coordenação da pesquisa de campo, orientação e revisão do artigo final. L. Carandina, M. B. A. Barros e M. Goldbaum contribuíram na elaboração do projeto e revisão do artigo final. M. C. G. P. Alves participou da elaboração do projeto, amostragem populacional e revisão do artigo final.</p>


            </div>
            <h5 style="margin-top: 25px;">AGRADECIMENTOS</h5>
            <div class="border-top-bottom">
                <p>Ao Conselho Nacional de Desenvolvimento Científico e Tecnológico (CNPq) pela bolsa de mestrado concedida a Shamyr Sulyvan de Castro, processo nº. 133707/2004-0. A Secretaria Estadual de Saúde de São Paulo, Secretaria Municipal de Saúde de São Paulo e Fundação de Amparo à Pesquisa do Estado de São Paulo (FAPESP) pelo financiamento para execução da pesquisa pelo projeto de políticas públicas, processo nº. 98/14099-7.</p>

            </div>

            <a href="artigo_pag12.php" style="float: left">Página anterior</a>
            <a href="artigo_pag14.php" style="float: right">Próxima página</a>
