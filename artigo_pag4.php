    ...
    <body >
        <div class="container">
            ...
            <div class="border-top-bottom">
                <p>Além da prevalência de deficiências auto-referidas, foram também obtidas estimativas referentes a variáveis sócio-demográficas (sexo, idade, escolaridade do chefe da família e estado civil, migração, raça e situação de trabalho do chefe da família), às causas auto-referidas das deficiências (doenças, causas congênitas, causas externas, envelhecimento e outras); e às dificuldades no trabalho trazidas pela deficiência.</p>
                <p>O protocolo da pesquisa foi aprovado pelo Comitê de Ética da Faculdade de Saúde Pública da Universidade de São Paulo. Os entrevistados assinaram um Termo de Consentimento Livre e Esclarecido no qual eram explicados os objetivos da pesquisa e as informações que seriam solicitadas, sendo assegurados o anonimato e a confidencialidade dos dados obtidos.</p>
                <p>Para assegurar o controle de qualidade da coleta de dados, as informações de cerca de 10% dos questionários foram verificadas por nova entrevista.</p>
                <p>Os dados foram analisados através do módulo survey do Stata, versão 9.2 (Stata Corp., College Station, Estados Unidos), tendo sido levados em consideração os distintos aspectos do plano complexo de amostragem: estratificação, sorteio de conglomerados e ponderação. Os pesos foram introduzidos para compensar as diferentes probabilidades de seleção aplicadas à população de estudo e ajustar a amostra à distribuição da população por idade e sexo, segundo dados do Instituto Brasileiro de Geografia e Estatística (IBGE; http://www.ibge.gov.br).</p>
                <p >Foi usada a regressão de Poisson 15, adotando-se o nível de significância de 0,20 (teste t) para inclusão da variável no modelo, e de 0,05 (estatística F) para a significância do modelo.</p>
            </div>

            <a href="artigo_pag3.php" style="float: left">Página anterior</a>
            <a href="artigo_pag5.php" style="float: right">Próxima página</a>
