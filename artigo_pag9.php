    ...
    <body >
        <div class="container">
            ...
            <div class="border-top-bottom">
                <p>Tratando-se da deficiência física, observou-se que a prevalência também aumenta com a idade, exceção feita para a faixa etária de 12 a 19 anos. Quando a prevalência de deficiência física é analisada segundo o sexo, percebe-se que a prevalência entre os homens é sempre maior do que nas mulheres, o que poderia ser explicado pela maior exposição a fatores de risco, como os ligados a acidentes de trabalho e de trânsito. Os dados observados na Tabela 3 corroboram essa afirmação, apontando as causas externas como a principal causa de deficiência física entre os homens.</p>
                <p>A prevalência de deficiências físicas pode sofrer variações de acordo com fatores regionais, Andresen et al. 40 ressaltam o quão diferente as prevalências são dentro dos Estados Unidos, variando de 30 a 200. Santos & Lessa 41, pesquisando populações faveladas e não faveladas em Salvador (Bahia, Brasil), encontraram prevalências de 62 e de 18, respectivamente. E, em contraste, com as prevalências apresentadas até agora, no Chile foi verificada uma prevalência de 655 de algum tipo de deficiência física 25. Esses dados mostram a importância dos determinantes sociais, geográficos e de saúde, próprios de cada localidade, no processo incapacitante, uma vez que os estudos citados usaram metodologias parecidas e apresentaram valores divergentes.</p>
                <p>Com o aumento da idade, também no caso das deficiências físicas, houve aumento na prevalência. Dados do IBGE em 2000 (Censo demográfico de 2000. http://www.ibge.org.br), Picavet & Hoeymans 31 e Estudio Nacional de La Discapacidad em Chile 25 também relataram esse comportamento. Depois dos ajustes por sexo verificou-se que na faixa etária 60 anos e mais registrou-se RP de 4,0 quando comparado com a faixa de idade de menores de 12 anos. Essa diferença é decorrente, possivelmente, de maior exposição a fatores etiológicos de deficiência como os acidentes de trabalho, acidentes de trânsito, doenças e outros fatores externos. A análise da distribuição das prevalências de deficiência física conforme o sexo mostrou maior freqüência entre os homens do que entre as mulheres. Essa diferença fica mais clara quando se analisa a RP de 2,3. A maior prevalência de deficiência física entre os homens pode ser justificada pelos fatores relatados acima, sendo que, na presente pesquisa, as causas externas foram, de maneira geral, a segunda maior causa identificada de deficiência física, entre os homens 46,5% das deficiências foram por causas externas e entre as mulheres somente 18,3%.</p>
            ...
            <a href="artigo_pag8.php" style="float: left">Página anterior</a>
            <a href="artigo_pag10.php" style="float: right">Próxima página</a>
